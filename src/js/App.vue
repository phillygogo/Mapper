<template>
<div>
	<div class="question showOff" id="question">
		{{question}}
	</div>
	<div class="gameOver question" id="gameOver">
		{{`Game Over! - Score: ${score}`}}
	</div>
	<div id="correct" class="correct" @click="nextQuestion">
		Correct!
	</div>
	...
	<div id="try-again" class="try-again failed">
		Keep Guessing! {{attempts}}
	</div>
	<div id="failed" class="try-again">
		No attempts left.
	</div>
	
	<div class="container">
			<!-- <div style="clear: both; width: 500px; height: 50px; border: 1px solid black;" id="selections"></div> -->
			<img id="NzMap" src="https://i.imgur.com/1ejd3nn.png" usemap="#Map">
			<map name="Map" id="Map">
				...
				<area shape="poly" coords="188,342,175,355,188,365,211,382,212,373,228,376,228,381,301,381,301,369,228,369,227,374,212,371,212,364" href="#" alt="Mt Cook" name="Mt Cook">
			...
			<img id="Nelson" class="regionName" src="https://i.imgur.com/i0bGeH2.png">
			<img id="West Coast" class="regionName" src="https://i.imgur.com/9nhlDFG.png">
			<img id="Wanaka" class="regionName" src="https://i.imgur.com/bnOE9l9.png">
			<img id="Queenstown" class="regionName" src="https://i.imgur.com/JG0yoNf.png">
			<img id="Fiordland" class="regionName" src="https://i.imgur.com/W1pBo81.png">
			<img id="Stewart Island" class="regionName" src="https://i.imgur.com/IXFcb3b.png">
			<img id="Otago" class="regionName" src="https://i.imgur.com/OAGwPBa.png">
			<img id="Dunedin" class="regionName" src="https://i.imgur.com/aii1D5d.png">
			<img id="Cromwell" class="regionName" src="https://i.imgur.com/IXTUA9R.png">
			<img id="Mt Cook" class="regionName" src="https://i.imgur.com/cDxWB7R.png">
			<img id="Christchurch" class="regionName" src="https://i.imgur.com/6ubSFuD.png">
			<img id="Canterbury" class="regionName" src="https://i.imgur.com/VxL90pl.png">
			<img id="Kaikoura" class="regionName" src="https://i.imgur.com/Ny8qL6H.png">
			<img id="Marlborough" class="regionName" src="https://i.imgur.com/hI8mQMk.png">
			<img id="Chatham Islands" class="regionName" src="https://i.imgur.com/DBuOoIu.png">
			<div class="game-hub">
				<div class="attempts">
					{{attempts}}
				</div>
	...
	export default {
		...
		data() {
			let locations = [
				...
				"Nelson","West Coast","Wanaka","Queenstown","Fiordland","Stewart Island",
				"Otago","Dunedin","Cromwell","Mt Cook",
				"Christchurch","Canterbury","Kaikoura","Marlborough","Chatham Islands"
			];
			return {
				pickedLoc: locations[Math.floor(Math.random() * locations.length)],
				score: 0,
				location: locations,
				questionNumber: 1,
				scorePotential: 3,
		...
		computed: {
			question() {
				return `Where in New Zealand is ${this.pickedLoc}?`
			},
			attempts() {
		...
		methods: {
			nextQuestion() {
				...
				//pick next location
				this.location = this.location.filter(item => item !== this.pickedLoc)
				this.pickedLoc = this.location[Math.floor(Math.random() * this.location.length)];
				...
				document.getElementById("failed").classList.remove("showOff");
			...
			image.mapster({
				...
				onClick: function(e) {
					...
					if(e.key == $vm.pickedLoc) {
						if($vm.questionNumber === 10) {
							document.getElementById("question").classList.remove("showOff");
							document.getElementById("next-question").classList.remove("showOff");
							document.getElementById("gameOver").classList.add("showOff");
						...
						if($vm.scorePotential == 0) {
							document.querySelector(".container :first-child").style.zIndex = 1;
							document.getElementById("try-again").classList.remove("showOff");
							document.getElementById("failed").classList.add("showOff");
							document.getElementById("next-question").classList.add("showOff");
						}
					}
				},
